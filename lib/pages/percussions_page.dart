...
class PercussionsPage extends StatefulWidget {
  ...
  @override
  _PercussionsPageState createState() => _PercussionsPageState();
}

class _PercussionsPageState extends State<PercussionsPage> {
  List<Map<String, String>> percussionsMusicians = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: percussionsMusicians.isEmpty
          ...
          : Column(
              ...
              children: [
                CarouselSlider.builder(
                  ...
                  itemCount: percussionsMusicians.length,
                  itemBuilder: (context, index, realIndex) {
                    final musicien = percussionsMusicians[index];
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: percussionsMusicians.asMap().entries.map((entry) {
