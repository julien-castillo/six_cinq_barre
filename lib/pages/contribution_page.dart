...
class ContributionPage extends StatelessWidget {
  ...
  Widget _buildGlassmorphicRectangle2(BuildContext context, String title, String subtitle) {
  return Container(
    width: 340,
    padding: const EdgeInsets.all(16.0),
    decoration: BoxDecoration(
  ...
  Widget _buildGlassmorphicCreditCard(BuildContext context, String rib, String bic) {
  return Container(
    width: 340,
    height: 200,
    ...
    child: Column(
      ...
      children: [
        Row(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(top: 0), // Remonter l'icône de la puce
              child: SvgPicture.asset(
                "assets/images/chip_icon.svg",
                colorFilter: const ColorFilter.mode(Color(0xFF00BCD4), BlendMode.srcIn),
                height: 100, // Ajustement de la hauteur pour plus de précision
              ),
            ),
            Padding(
