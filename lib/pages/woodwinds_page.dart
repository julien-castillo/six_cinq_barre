...
class WoodwindsPage extends StatefulWidget {
  ...
  @override
  _WoodwindsPageState createState() => _WoodwindsPageState();
}

class _WoodwindsPageState extends State<WoodwindsPage> {
  List<Map<String, String>> woodwindsMusicians = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Bois'),
      ),
      backgroundColor: Colors.black,
      body: woodwindsMusicians.isEmpty
          ...
          : Column(
              ...
              children: [
                CarouselSlider.builder(
                  ...
                  itemCount: woodwindsMusicians.length,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: woodwindsMusicians.asMap().entries.map((entry) {
