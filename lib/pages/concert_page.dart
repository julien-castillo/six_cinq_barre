...
class _ConcertPageState extends State<ConcertPage> {
  ...
  Widget _buildGlassmorphicRectangleConcert(
    ...
    return GestureDetector(
      onTap: () {
        _showConcertDetailsDialog(
            context, date, heure, lieu, informationsConcert, programme);
      },
      child: Container(
        padding: const EdgeInsets.all(16.0),
        decoration: BoxDecoration(
  ...
  void _showConcertDetailsDialog(BuildContext context, String date,
      String heure, String lieu, String informationsCncert, String programme) {
    showDialog(
      context: context,
